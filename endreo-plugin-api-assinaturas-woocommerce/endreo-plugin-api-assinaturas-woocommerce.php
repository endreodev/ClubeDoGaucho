<?php
/**
 * Plugin Name: API Assinaturas 
 * Description: Fornece API de assinaturas de clientes
 * Version: 2.0
...
add_action('rest_api_init', function () {
    register_rest_route('wc/v1', '/custom-subscriptions', array(
        'methods'  => WP_REST_Server::READABLE,
        'callback' => 'get_custom_subscriptions',
...
function get_custom_subscriptions($request)
{
    ...
    foreach ($latest_subscriptions as $subscription) {
        ...
        $status_traduzido = traduzir_status_assinatura($subscription->get_status());
...
function traduzir_status_assinatura($status)
{
